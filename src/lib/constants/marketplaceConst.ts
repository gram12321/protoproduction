...
export const DEMAND_SHOCK_NEGATIVE_OUTCOME_CHANCE = 0.5;

export const SELLER_WEIGHT_RANDOMIZATION_MIN = 0.95;
export const SELLER_WEIGHT_RANDOMIZATION_RANGE = 0.1;
export const MARKETPLACE_ACTIVE_SELLER_COUNT = 3;
export const FOLLOWER_NPC_PRICE_ADJUSTMENT_MULTIPLIER = 0.05;
export const FOLLOWER_NPC_LOW_SELL_THROUGH_THRESHOLD = 0.1;
export const FOLLOWER_NPC_MIN_QUANTITY_FLOOR = 1;
export const FOLLOWER_NPC_SMOOTHING_TICK_WINDOW = 4;
