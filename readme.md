...
Turn-based single-player resource production simulation built with React, TypeScript, Vite, Tailwind, ShadCN UI, and Supabase.

The game models ressource production, sale, and consumption, finance, prestige, achievements, and company progression. Core simulation logic lives in services; React components should stay focused on presentation and interaction.
...
- Keep wine terminology aligned with `docs/CONTEXT.md`: Structure, Taste Quality, WineScore, and compact wine anchors.
